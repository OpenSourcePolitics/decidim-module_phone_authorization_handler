    ...
    describe "contents" do
      ...
      describe "proposals" do
        ...
        it "doesn't include the admin proposals data" do
          expect(csv_data).not_to include(proposal.creator_author.name)
          expect(csv_data).not_to include(proposal.creator_author.nickname)
          expect(csv_data).not_to include(proposal.creator_author.email)
        end
